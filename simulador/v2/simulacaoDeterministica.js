...
SimulacaoDeterministica.prototype.executarPessoasNaFila = function(lambda){
...
SimulacaoDeterministica.prototype.executarTempoPessoasNaFila = function(lambda){
    this.classe1.setLambda(lambda);
...
SimulacaoDeterministica.prototype.executarFracaoTempoServidorVazio = function(lambda){
    this.classe1.setLambda(lambda);
...
SimulacaoDeterministica.prototype.executarFracaoChegadasServidorVazio = function(lambda){
    this.classe1.setLambda(lambda);
...
SimulacaoDeterministica.prototype.executar = function(inicio, _final, incremento){
    var mediaPessoa = [];
    var mediaTempo = [];
    var mediaTempoVazio = [];
...
//Questão 6
SimulacaoDeterministica.prototype.executarTempoEntreSaidasDeCliente = function(filename) {
    console.log();
    var simulador = this.getSimulador(this.tempoFinal, this.classe1, this.classe2);
    var metricaDeInteresse = simulador.iniciarSimulacao();
...
//Questão 8
SimulacaoDeterministica.prototype.executarTrabalhoPendente = function(lambda) {
    this.classe1.setLambda(lambda);
...
SimulacaoDeterministica.prototype.executarMediaPessoasFilas = function(lambda) {
    this.classe1.setLambda(lambda);
